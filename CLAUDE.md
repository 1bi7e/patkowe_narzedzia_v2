...
- [aplikacja-design/](aplikacja-design/) — wireframes (`*.dc.html` design-canvas files, open in a browser) and the exported design system (also untracked — keep it out of git)
